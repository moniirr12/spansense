...
// Add this function to build the BCI Proforma content for pdfMake
function buildBCIProformaContent(bciFormData) {
    ...
    for (var spanIdx = 0; spanIdx < totalSpans; spanIdx++) {
        ...
        // ROW 1: Category headers (20 cols: 3+3+3+3+8)
        tableBody.push([
        ...
        // ✅ FIX: 9 empty fillers after colSpan:10 (was 10, causing 21 cells)
        tableBody.push([
            { text: 'Bridge name: ' + structureName, colSpan: 10, fontSize: 7, bold: true },
            { text: '' }, { text: '' }, { text: '' }, { text: '' }, { text: '' }, 
            { text: '' }, { text: '' }, { text: '' }, { text: '' },  // 9 empty fillers
        ...
        // ROW 4: MapRef(5) | OSE(5) | OSN(6) | [rowSpan] | PrimaryMat(3) = 20
        tableBody.push([
        ...
        BCI_GROUPS.forEach(function(group) {
            ...
            groupEls.forEach(function(el, idxInGroup) {
                var d = defByEl[el.no] || {};
                var hasMulti = defects.filter(function(x) { 
                    return (x.element_no != null ? x.element_no : x.elementNumber) === el.no; 
                }).length > 1;
                ...
                dataRow.push({ text: '' }); dataRow.push({ text: '' }); dataRow.push({ text: '' }); dataRow.push({ text: '' });
                ...
                dataRow.push({ text: '' }); dataRow.push({ text: '' }); dataRow.push({ text: '' }); dataRow.push({ text: '' }); dataRow.push({ text: '' });
        ...
        BCI_SPARE.forEach(function(no, i) {
            ...
            spareRow.push({ text: '' }); spareRow.push({ text: '' }); spareRow.push({ text: '' }); spareRow.push({ text: '' });
            ...
            spareRow.push({ text: '' }); spareRow.push({ text: '' }); spareRow.push({ text: '' }); spareRow.push({ text: '' }); spareRow.push({ text: '' });
        ...
        // ✅ FIX: Added headerRows: 8 so pdfmake knows which rows are headers
        // This ensures borders render correctly and repeat on page breaks
        content.push({
            margin: [0, 8, 0, 0],
            table: {
                widths: COL_WIDTHS,
                body: tableBody,
                headerRows: 8,  // Rows 0-7 are headers
            },
            layout: GRID_LAYOUT,
        });
    }
